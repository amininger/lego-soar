...
typedef   enum
{
  _CONN_UNKNOWN                  = 111,  //!< Connection is fake (test)

  _CONN_DAISYCHAIN               = 117,  //!< Connection is daisy chained
  _CONN_NXT_COLOR                = 118,  //!< Connection type is NXT color sensor
  _CONN_NXT_DUMB                 = 119,  //!< Connection type is NXT analog sensor
  _CONN_NXT_IIC                  = 120,  //!< Connection type is NXT IIC sensor

  _CONN_INPUT_DUMB               = 121,  //!< Connection type is LMS2012 input device with ID resistor
  _CONN_INPUT_UART               = 122,  //!< Connection type is LMS2012 UART sensor

  _CONN_OUTPUT_DUMB              = 123,  //!< Connection type is LMS2012 output device with ID resistor
  _CONN_OUTPUT_INTELLIGENT       = 124,  //!< Connection type is LMS2012 output device with communication
  _CONN_OUTPUT_TACHO             = 125,  //!< Connection type is LMS2012 tacho motor with series ID resistance

  _CONN_NONE                     = 126,  //!< Port empty or not available
  _CONN_ERROR                    = 127,  //!< Port not empty and type is invalid
}
CONN;
